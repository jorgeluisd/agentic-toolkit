---
description: Arranca una sesión leyendo el estado local del proyecto (AGENTS.md, ADRs, plan/backlog, último 08-close.md) y reporta dónde estamos antes de tocar código.
---

...
3. Lanza cada agente como agente aparte **pasándole solo las referencias de los artefactos previos ya resueltas a ruta, y su tarea** — nunca el historial de esta conversación ni el cuerpo de un artefacto. No lanzas un agente si falta el artefacto anterior: verifica que sea legible antes de lanzar. Si esta sesión no puede lanzar agentes aparte, seguí `.opencode/sdd-tdd-core/ORCHESTRATOR-solo.md`: mismas fases y mismos gates, ejecutados en secuencia por vos.

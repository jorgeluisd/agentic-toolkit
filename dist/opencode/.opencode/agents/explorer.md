...
- `AGENTS.md` del proyecto (fuente de verdad de contexto, stack e invariantes).
- Skill local de invariantes del proyecto, si existe (`.opencode/skills/<proyecto>-invariants/`).
- ADRs del proyecto y plan/backlog (rutas declaradas en `AGENTS.md`).
...
## Proceso
1. Lee `AGENTS.md`, la skill local de invariantes y los ADRs afines (busca por tema, no leas todos).

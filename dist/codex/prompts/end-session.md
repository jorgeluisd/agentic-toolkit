---
description: Cierra la sesión — resumen, estado git, clasificación de hallazgos (ADR / plan / AGENTS.md / runbook / código) y updates propuestos al repo con OK explícito antes de aplicar.
---

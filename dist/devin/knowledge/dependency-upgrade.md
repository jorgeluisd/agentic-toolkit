...
**Cuándo aplica (trigger de la entrada de Knowledge):** Reglas duras para dependencias con pnpm: versiones exactas con save-exact, madurez de 72 h verificada en el registry, scripts de instalación solo con aprobación explícita, flujo por grupos con checks, ADR para majors del stack, audit y lockfile. Usar cuando se agrega, sube o fija un paquete.

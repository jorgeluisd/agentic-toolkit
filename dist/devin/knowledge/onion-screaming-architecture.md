...
**Cuándo aplica (trigger de la entrada de Knowledge):** Capas Onion, matriz de imports, carpetas por bounded context, sufijos de archivo y enforcement con eslint-plugin-boundaries. Usar cuando se crea o mueve un archivo, se decide capa o contexto, se crea un bounded context o el lint marca boundaries.

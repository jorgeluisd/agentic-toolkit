...
**Cuándo aplica (trigger de la entrada de Knowledge):** Aggregates, value objects y eventos en TypeScript puro: constructor privado + create() con Result, rehydrate(), Identifier<Brand>, Money entero, tiempo e ids inyectados, append-only con compensación. Usar cuando se escribe o revisa código bajo domain/.

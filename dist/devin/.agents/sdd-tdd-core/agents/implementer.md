...
5. Checks locales al cerrar la tarea: typecheck, lint (boundaries) y los tests de los archivos tocados. Los comandos son los declarados en la sección "Comandos" del `AGENTS.md` del proyecto.

---
description: Cierra la sesión — resumen, estado git, clasificación de hallazgos (ADR / plan / {{CONTEXT_DOC}} / runbook / código) y updates propuestos al repo con OK explícito antes de aplicar.
---
...
3. **Clasifica cada hallazgo**:
   ...
   c) Cambio en cómo se trabaja → update del `{{CONTEXT_DOC}}` del proyecto o de su skill local de invariantes.

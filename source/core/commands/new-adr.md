...
1. **Numeración**: lista la carpeta de ADRs del proyecto (ruta en `{{CONTEXT_DOC}}`, por defecto `docs/adr/`) y toma el siguiente número con el mismo ancho de dígitos que los existentes. Confirma el número. Nunca lo inventes.

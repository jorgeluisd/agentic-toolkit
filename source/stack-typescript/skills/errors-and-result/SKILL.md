...
| `publicMessage` | `string` | Va al body de la respuesta: sin PII, sin ids internos, sin jerga técnica, en el idioma del producto (dialecto según el {{CONTEXT_DOC}} del proyecto). Default genérico por familia: olvidar el copy da un mensaje pobre, nunca una fuga |

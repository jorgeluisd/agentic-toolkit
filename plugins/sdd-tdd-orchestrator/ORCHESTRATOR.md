...
1. **Skills primero.** Antes de escribir, el agente carga las skills del plugin que apliquen y la skill local de invariantes del proyecto, si existe. La skill local prima sobre el default del plugin.

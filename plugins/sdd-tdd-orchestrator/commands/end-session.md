...
2. **Git**: `git status` y `git log --oneline -5`. Si hay cambios sin commitear, propón los commits siguiendo `delivery-workflow` (formato, español neutro, sin trailers de IA, identidad personal) y **espera el OK** antes de ejecutarlos. Confirma si hay push y PR, o qué queda pendiente.

...
- Skills: `onion-screaming-architecture`, `domain-modeling`, `application-cqrs-jobs`, `errors-and-result`, `testing-conventions`, `strict-tdd`; las demás según lo que toque el diff. Skill local de invariantes del proyecto.

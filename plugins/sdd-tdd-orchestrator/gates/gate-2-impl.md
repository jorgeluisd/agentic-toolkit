...
**Posición:** después de `06-verify.md` en PASS y de `07-security.md` (si corrió). **Un FAIL del verifier nunca llega aquí.** Este gate no repite los checks mecánicos: contiene solo lo que un humano debe decidir.
